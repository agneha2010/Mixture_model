...
#tt = rexp(1000,param.val$true.eta0)
#ss = rexp(1000,param.val$true.eta1)
...
write.csv(est,"aUnknown_est.semiparametric_proband_genotype_n2000_beta1_a0.1.csv")
write.csv(est.parametric.trio,"aUnknown_est.parametric.trio_proband_genotype_n2000_beta1_a0.1.csv")
write.csv(est.parametric.pairs,"aUnknown_est.parametric.pairs_proband_genotype_n2000_beta1_a0.1.csv")
write.csv(est.parametric.just.moth,"aUnknown_est.parametric.just.moth_proband_genotype_n2000_beta1_a0.1.csv")

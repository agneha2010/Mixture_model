...
est = read.csv("aUnknown_est.semiparametric_proband_genotype_n1000_beta0.3_a0.1.csv")
est.parametric.trio = read.csv("aUnknown_est.parametric.trio_proband_genotype_n1000_beta0.3_a0.1.csv")
est.parametric.pairs = read.csv("aUnknown_est.parametric.pairs_proband_genotype_n1000_beta0.3_a0.1.csv")
est.parametric.just.moth = read.csv("aUnknown_est.parametric.just.moth_proband_genotype_n1000_beta0.3_a0.1.csv")

est = read.csv("aUnknown_est.semiparametric_proband_genotype_n1000_beta1_a0.1.csv")
est.parametric.trio = read.csv("aUnknown_est.parametric.trio_proband_genotype_n1000_beta1_a0.1.csv")
est.parametric.pairs = read.csv("aUnknown_est.parametric.pairs_proband_genotype_n1000_beta1_a0.1.csv")
est.parametric.just.moth = read.csv("aUnknown_est.parametric.just.moth_proband_genotype_n1000_beta1_a0.1.csv")
...
m1 = round(c(colMeans(est1,na.rm = T)[4],colMeans(est.converted.trio,na.rm = T)[1],
             colMeans(est.converted.pairs,na.rm = T)[1],colMeans(est.converted.just.moth,na.rm = T)[1]),2)

m2 = round(c(apply(est1,2, function(x) sd(x,na.rm=T))[4],apply(est.converted.trio,2,function(x) sd(x,na.rm=T))[1],
             apply(est.converted.pairs, 2, function(x) sd(x,na.rm=T))[1],
             apply(est.converted.just.moth,2,function(x) sd(x,na.rm=T))[1]),2)

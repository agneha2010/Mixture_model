...
write.csv(est,"aUnknown_est.semiparametric_proband_genotype_n50_beta0.3_a0.1.csv")
write.csv(est.parametric.trio,"aUnknown_est.parametric.trio_proband_genotype_n50_beta0.3_a0.1.csv")
write.csv(est.parametric.pairs,"aUnknown_est.parametric.pairs_proband_genotype_n50_beta0.3_a0.1.csv")
write.csv(est.parametric.just.moth,"aUnknown_est.parametric.just.moth_proband_genotype_n50_beta0.3_a0.1.csv")

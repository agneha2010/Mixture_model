...
param.val = list(n = 666, ## proband sample size
                 a = 0.1,
                 true.mu0 = 1.7,
                 true.mu1 = 2,
                 true.sigma = 1,
...
write.csv(est,"aUnknown_est.semiparametric_theta1_genotype_n666_beta0.3_a0.1.csv")
write.csv(est.parametric.trio,"aUnknown_est.parametric.trio_theta1_genotype_n666_beta0.3_a0.1.csv")
write.csv(est.parametric.pairs,"aUnknown_est.parametric.pairs_theta1_genotype_n666_beta0.3_a0.1.csv")
write.csv(est.parametric.just.moth,"aUnknown_est.parametric.just.moth_theta1_genotype_n666_beta0.3_a0.1.csv")

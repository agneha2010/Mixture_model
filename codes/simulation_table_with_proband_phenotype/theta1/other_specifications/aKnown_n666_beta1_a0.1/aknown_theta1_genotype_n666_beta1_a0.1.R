...
write.csv(est,"aknown_est.semiparametric_theta1_genotype_n666_beta1_a0.1.csv")
write.csv(est.parametric.trio,"aknown_est.parametric.trio_theta1_genotype_n666_beta1_a0.1.csv")
write.csv(est.parametric.pairs,"aknown_est.parametric.pairs_theta1_genotype_n666_beta1_a0.1.csv")
write.csv(est.parametric.just.moth,"aknown_est.parametric.just.moth_theta1_genotype_n666_beta1_a0.1.csv")

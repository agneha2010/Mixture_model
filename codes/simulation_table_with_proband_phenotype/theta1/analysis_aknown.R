...
est = read.csv("aknown_est.semiparametric_theta1_genotype_n666_beta0.3_a0.1.csv")
est.parametric.trio = read.csv("aknown_est.parametric.trio_theta1_genotype_n666_beta0.3_a0.1.csv")
est.parametric.pairs = read.csv("aknown_est.parametric.pairs_theta1_genotype_n666_beta0.3_a0.1.csv")
est.parametric.just.moth = read.csv("aknown_est.parametric.just.moth_theta1_genotype_n666_beta0.3_a0.1.csv")

est = read.csv("aknown_est.semiparametric_theta1_genotype_n666_beta1_a0.1.csv")
est.parametric.trio = read.csv("aknown_est.parametric.trio_theta1_genotype_n666_beta1_a0.1.csv")
est.parametric.pairs = read.csv("aknown_est.parametric.pairs_theta1_genotype_n666_beta1_a0.1.csv")
est.parametric.just.moth = read.csv("aknown_est.parametric.just.moth_theta1_genotype_n666_beta1_a0.1.csv")

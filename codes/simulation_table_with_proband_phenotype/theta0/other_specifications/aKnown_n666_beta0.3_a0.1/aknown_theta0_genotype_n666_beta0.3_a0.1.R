...
write.csv(est,"aknown_est.semiparametric_theta0_genotype_n666_beta0.3_a0.1.csv")
write.csv(est.parametric.trio,"aknown_est.parametric.trio_theta0_genotype_n666_beta0.3_a0.1.csv")
write.csv(est.parametric.pairs,"aknown_est.parametric.pairs_theta0_genotype_n666_beta0.3_a0.1.csv")
write.csv(est.parametric.just.moth,"aknown_est.parametric.just.moth_theta0_genotype_n666_beta0.3_a0.1.csv")

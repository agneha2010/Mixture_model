...
write.csv(est,"aUnknown_est.semiparametric_theta0_genotype_n5000_beta0.3_a0.1.csv")
write.csv(est.parametric.trio,"aUnknown_est.parametric.trio_theta0_genotype_n5000_beta0.3_a0.1.csv")
write.csv(est.parametric.pairs,"aUnknown_est.parametric.pairs_theta0_genotype_n5000_beta0.3_a0.1.csv")
write.csv(est.parametric.just.moth,"aUnknown_est.parametric.just.moth_theta0_genotype_n5000_beta0.3_a0.1.csv")

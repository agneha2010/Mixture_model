...
write.csv(est,"aknown_est.semiparametric_proband_genotype_n1333_beta1_a0.1.csv")
write.csv(est.parametric.trio,"aknown_est.parametric.trio_proband_genotype_n1333_beta1_a0.1.csv")
write.csv(est.parametric.pairs,"aknown_est.parametric.pairs_proband_genotype_n1333_beta1_a0.1.csv")
write.csv(est.parametric.just.moth,"aknown_est.parametric.just.moth_proband_genotype_n1333_beta1_a0.1.csv")

library(dplyr)
library(invgamma)
### mutated & non-mutated type, a known
...
#mu2beta.f(c(param.val$true.mu0,param.val$true.mu1,param.val$true.sigma))
...
write.csv(est,"aknown_est.semiparametric_proband_genotype_n2000_beta0.3_a0.1.csv")
write.csv(est.parametric.trio,"aknown_est.parametric.trio_proband_genotype_n2000_beta0.3_a0.1.csv")
write.csv(est.parametric.pairs,"aknown_est.parametric.pairs_proband_genotype_n2000_beta0.3_a0.1.csv")
write.csv(est.parametric.just.moth,"aknown_est.parametric.just.moth_proband_genotype_n2000_beta0.3_a0.1.csv")

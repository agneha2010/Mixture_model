...
c(mu2beta.f(c(param.val$true.mu0,param.val$true.mu1,param.val$true.sigma,param.val$a)),round(colMeans(est.semiparametric.pairs,na.rm = T),2)[4:6],round(apply(est.semiparametric.pairs,2, function(x) sd(x,na.rm=T)),2)[4:6])

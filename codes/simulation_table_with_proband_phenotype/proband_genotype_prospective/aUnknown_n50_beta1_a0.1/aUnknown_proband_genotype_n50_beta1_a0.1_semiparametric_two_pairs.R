...
#colMeans(est.semiparametric.pairs,na.rm = T)
#apply(est.semiparametric.pairs,2, function(x) sd(x,na.rm=T))
write.csv(est.semiparametric.pairs,"aUnknown_est.semiparametric.pairs_proband_genotype_n50_beta1_a0.1.csv")
